...
mig_sys = listdlg('PromptString',prompt_mig,'ListString',migr_str);
...
base_lst_wdth = inputdlg(prompt_lost_wdth,dlgtitle, ...
    fieldsize,definput);
lst_Lt_wdth = str2double(base_lst_wdth{1});
lst_Ln_wdth = str2double(base_lst_wdth{2});
...
if n_loci_opt <= 2 
    ...
    match_Lon_nr = listdlg('PromptString',prompt_match_Lon,'ListString',{'No','by Lon'}); 
...
plot_opt = listdlg('PromptString',prompt_plot,'ListString',plot_list);
...
veg_mod_pal = listdlg('PromptString',prompt_veg,'ListString',veg_list);
...
incl_wind_pr = listdlg('PromptString',prompt_wind,'ListString',wind_list);
...
definput = {'36', '84','2'}; % 1.5 {'72', '72','2.0'};
fieldsize = [1 45; 1 45; 1 45];
dlgtitle = 'Input';
...
fieldsize = [1 45; 1 45; 1 45; 1 45; 1 45; 1 45];
dlgtitle = 'Input';
std_str = inputdlg(prompt_stds,dlgtitle, ...
    fieldsize,definput);
...
opt_evo_nr = listdlg('PromptString',prompt_optzn,'ListString',optzn_list);
